...
//---------------------------------------------------        
		...
		String output = "Please input your weight in kg and your height"
                        + " in cm";

		if (check_age) {
			label_result.setText(output);
		} else {
			JOptionPane.showMessageDialog(this, "You only can input"
                                + " the age between 1 and 100");
		}
    ...
    private void btn_countActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_countActionPerformed
		...
		if (BMI >= 30) {
			ta_result.setText("For the information you entered:"
					...
					+ "\nYour BMI is " + BMI + ", indicating"
                                        + " your weight is in the Obese category.");
		} else if (BMI >= 25) {
			ta_result.setText("For the information you entered:"
					+ "\nHeight: " + inputHeight + " centimeters"
					+ "\nWeight: " + inputWeight + " kilogram"
					+ "\nYour BMI is " + BMI + ", indicating"
                                        + " your weight is in the Overweight category.");
		} else if (BMI >= 18.5) {
			ta_result.setText("For the information you entered:"
					+ "\nHeight: " + inputHeight + " centimeters"
					+ "\nWeight: " + inputWeight + " kilogram"
					+ "\nYour BMI is " + BMI + ", indicating"
                                        + " your weight is in the Normal category.");
		} else
			ta_result.setText("For the information you entered:"
                    + "\nHeight: " + inputHeight + " centimeters"
                    + "\nWeight: " + inputWeight + " kilogram"
    ...
    private void btn_tipsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tipsActionPerformed
		...
		if (BMI >= 30) {
			ta_tips.setText("1. Change your diet. To lose weight,"
                                + " you have to reduce"
			...
			ta_tips.setText("1. Diet. A steady weight loss of about"
                                + " one pound a week is"
                    + "\nthe safest way to lose weight."
                    + "\n2. Regular exercise such as brisk walking, running,"
                    + "\nswimming, biking, and dancing.");
		} else if (BMI >= 18.5) {
			ta_tips.setText("It's important to exercise at least"
                                + " 60-90 minutes most days"
                    + "\nof the week. Staying hydrated and eat a balanced diet"
                    + "\nare equally important.");
		} else
			ta_tips.setText("1. Eat more frequently."
                                + " When you're underweight, you may feel"
